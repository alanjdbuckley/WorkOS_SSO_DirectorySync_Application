...
#STATIC_URL = '/static/'
#STATICFILES_DIRS = [
 #   os.path.join('/Users/alanbuckley/Library/Python/3.9/lib/python/site-packages/python-django-example-applications/python-django-sso-example/sso', 'static'),
#]
...
STATICFILES_DIRS = [
    '/Users/alanbuckley/Library/Python/3.9/lib/python/site-packages/python-django-example-applications/python-django-sso-example/sso/static',
]
